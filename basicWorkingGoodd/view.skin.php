...
<div class="view-wrap<?php echo (G5_IS_MOBILE) ? ' view-mobile font-14' : '';?>">
	<h1><?php if($view['photo']) { ?><img src="<?php echo $view['photo'];?>" class="photo" alt=""><?php } ?>
	<?php echo $view['subject']; ?></h1>
	<h1>qb_1: <?php echo $view['qb_1']; ?></h1>
	<h1>qb_2: <?php echo $view['qb_2']; ?></h1>
	<h1>qb_3: <?php echo $view['qb_3']; ?></h1>
	<h1>qb_4: <?php echo $view['qb_4']; ?></h1>
	<h1>qb_5: <?php echo $view['qb_5']; ?></h1>
	<h1>qb_15: <?php echo $view['qb_15']; ?></h1>
	<h1>qb_25: <?php echo $view['qb_25']; ?></h1>
	<h1>qa_1: <?php echo $view['qa_1']; ?></h1>
	<h1>qa_2: <?php echo $view['qa_2']; ?></h1> 
