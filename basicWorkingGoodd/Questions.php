<div id='Questions'>
	<div class="col-sm-12">  
		...
		<div class="form-group">
			<label class="col-sm-2 control-label" for="qb_4">qb_4</label>
			<div class="col-sm-10"> 
				<input type="text" name="qb_4" value="<?php echo get_text($write['qb_4']); ?>" id="qb_4" class="form-control input-sm" size="50" maxlength="255">
