...
<div id="bo_w" class="write-wrap box-colorset<?php echo (G5_IS_MOBILE) ? ' box-colorset-mobile' : '';?>">
	...
	<div class="form-group">
		<label class="col-sm-2 control-label" for="qa_1">qa_1<strong class="sound_only">필수</strong></label>
		<div class="col-sm-10"> 
			<input type="text" name="qa_1" value="<?php echo get_text($write['qa_1']); ?>" id="qa_2" required class="form-control input-sm" size="50" maxlength="255">
			<input type="hidden" name="qa_html" value="1"> 
		</div>
	</div>

	<div class="form-group">
		<label class="col-sm-2 control-label" for="qa_2">qa_2<strong class="sound_only">필수</strong></label>
		<div class="col-sm-10"> 
			<input type="text" name="qa_2" value="<?php echo get_text($write['qa_2']); ?>" id="qa_2" required class="form-control input-sm" size="50" maxlength="255">
			<input type="hidden" name="qa_html" value="1"> 
		</div>
	</div>

	<div class="form-group">
		<label class="col-sm-2 control-label" for="qa_3">qa_3<strong class="sound_only">필수</strong></label>
		<div class="col-sm-10"> 
			<input type="text" name="qa_3" value="<?php echo get_text($write['qa_3']); ?>" id="qa_3" required class="form-control input-sm" size="50" maxlength="255">
			<input type="hidden" name="qa_html" value="1"> 
		</div>
	</div>

	<div class="form-group">
		<label class="col-sm-2 control-label" for="qa_4">qa_4<strong class="sound_only">필수</strong></label>
		<div class="col-sm-10"> 
			<input type="text" name="qa_4" value="<?php echo get_text($write['qa_4']); ?>" id="qa_4" required class="form-control input-sm" size="50" maxlength="255">
			<input type="hidden" name="qa_html" value="1"> 
		</div>
	</div>

	<div class="form-group">
		<label class="col-sm-2 control-label" for="qa_5">qa_5<strong class="sound_only">필수</strong></label>
		<div class="col-sm-10"> 
			<input type="text" name="qa_5" value="<?php echo get_text($write['qa_5']); ?>" id="qa_5" required class="form-control input-sm" size="50" maxlength="255">
			<input type="hidden" name="qa_html" value="1"> 
		</div>
	</div>

	<div class="form-group">
		<label class="col-sm-2 control-label" for="qb_15">qb_15<strong class="sound_only">필수</strong></label>
		<div class="col-sm-10"> 
			<input type="text" name="qb_15" value="<?php echo get_text($write['qb_15']); ?>" id="qb_15" required class="form-control input-sm" size="50" maxlength="255">
			<input type="hidden" name="qb_html" value="1"> 
		</div>
	</div>

	<div class="form-group">
		<label class="col-sm-2 control-label" for="qb_25">qb_25<strong class="sound_only">필수</strong></label>
		<div class="col-sm-10"> 
			<input type="text" name="qb_25" value="<?php echo get_text($write['qb_25']); ?>" id="qb_25" required class="form-control input-sm" size="50" maxlength="255">
			<input type="hidden" name="qb_html" value="1"> 
		</div>
	</div>

	<div class="form-group">
		<label class="col-sm-2 control-label" for="qb_35">qb_35<strong class="sound_only">필수</strong></label>
		<div class="col-sm-10"> 
			<input type="text" name="qb_35" value="<?php echo get_text($write['qb_35']); ?>" id="qb_35" required class="form-control input-sm" size="50" maxlength="255">
			<input type="hidden" name="qb_html" value="1"> 
		</div>
	</div>

	<div class="form-group">
		<label class="col-sm-2 control-label" for="qb_45">qb_45<strong class="sound_only">필수</strong></label>
		<div class="col-sm-10"> 
			<input type="text" name="qb_45" value="<?php echo get_text($write['qb_45']); ?>" id="qb_45" required class="form-control input-sm" size="50" maxlength="255">
			<input type="hidden" name="qb_html" value="1"> 
		</div>
	</div> 
